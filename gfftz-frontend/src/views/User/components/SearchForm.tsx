...
import type { IUserQueryForm } from '../types'

const { RangePicker } = DatePicker

interface IProps {
  onSearch: (row: IUserQueryForm) => void
  onReset: () => void
  onRefresh: () => void
  onBatchDelete: () => void
}
    ...
    <div>
      <div className="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 mb-5">
        <div className="flex items-center">
          <div className="pr-3 basis-20 text-right">用户名:</div>
        ...
        <div className="flex items-center">
          <div className="pr-3 basis-20 text-right">手机号:</div>
          <div className="flex-1 min-w-0">
            <Controller
              name="mobile"
              control={control}
